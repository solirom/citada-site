...
java -jar ~/workspace/repositories/git/solirom-xquery-service/bin/saxon9he.jar -s:"./tmp/${project_name}/files/xml/" -xsl:"./static/modules/tei-to-html/tei-to-html.xsl" -o:"$output_dir" 2>error.log
